...
export default function Benefits() {
  ...
  return (
    ...
    >
        ...
        <div className="absolute -bottom-40 -left-40 w-96 h-96 bg-brand-orange/[0.03] rounded-full blur-3xl pointer-events-none" />
        ...
        <div className="relative z-10">
          <div className="text-center mb-16">
            <div className="benefits-badge inline-flex items-center gap-2 bg-brand-green/10 text-brand-green rounded-lg px-4 py-1.5 mb-6 border border-brand-green/20">
              ...
              <span className="text-xs font-semibold tracking-wide">Beneficios</span>
            </div>
            ...
            <p className="benefits-desc text-brand-text-light text-base sm:text-lg max-w-2xl mx-auto font-medium text-center">
              Diseñada para personas reales con vidas reales. Moveat se adapta a vos, no al revés.
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 relative">
            {expectations.map((item, i) => (
              <div
                key={i}
                className={`benefit-card group bg-white/50 backdrop-blur-sm rounded-2xl p-6 hover:bg-white hover:shadow-xl transition-all duration-300 border border-gray-200/30 hover:border-brand-orange/30 ${i === 4 ? 'relative' : ''}`}
              >
                {i === 4 && (
                ...
                <div className="relative z-10">
                   <div className="font-heading font-black text-2xl text-brand-green/40 mb-3 group-hover:text-brand-orange transition-colors tabular-nums">
                     0{i + 1}
                   </div>
          ...
          <div className="mt-16 max-w-3xl mx-auto text-center border-t border-gray-200/30 pt-12">
            ...
            <p className="text-brand-text-light text-base mb-6 leading-relaxed">
              El mayor obstáculo en la salud es la rigidez. Si comés algo fuera de tu plan, las aplicaciones tradicionales te muestran números rojos y alertas que generan frustración.
            </p>
            <p className="text-brand-text-light text-base mb-6 leading-relaxed">
              Palti cree en el progreso sobre la perfección. En lugar de juzgarte, reajusta tus metas del día de manera constructiva y te da alternativas saludables para mantener tu racha sin estrés.
            </p>
          ...
          {/* KPIs / Stats */}
          <div className="mt-20 bg-[#0F0E0C] rounded-3xl p-8 sm:p-12 border border-white/5 shadow-2xl">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              {[
                ...
                <div key={i} className="text-center">
                  ...
                  <div className="text-white/60 text-xs sm:text-sm font-medium tracking-wide">{stat.label}</div>
                </div>
              ))}
            </div>
          </div>
